...
<div class="padding-xs">
	<div class="panel panel-default">
		<div class="panel-heading"  style="font-size:14px; height:52px;">
			...
			<a class="btn btn-success btn-sm pull-right" href="<c:url value="/mgmt/input?mobile"/>" style="margin-right:5px; width: 100px;">
		...
		<div class="panel-body">
			<table class="table table-striped table-hover" id="table">
				...
				<c:forEach items="${list}" var="entry">
					<tr>
						<td style="width:120px;"><a class='glink' href="<c:url value="/mgmt/detail/${entry.id}?mobile"/>">${entry.name}</a>
					</tr>
				</c:forEach>
				</tbody>
			</table>
