...
<div class="padding-xs">
	...
	<div class="panel panel-default">
		<div class="panel-heading" style="font-size:14px; height:78px;">
			...
			<a class="glink" href="<c:url value="/warehouse/inventory/${obj.warehouse.id}?mobile"/>">${obj.warehouse.name}</a>
			</div>
		...
		<div class="panel-body">
			...
			<div class="form-group">
				<label class="col-md-2 control-label" for="unit">单位</label>
				<div class="col-md-8">
	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<div class="modal-footer">
        		...
        		<a type="button" class="btn btn-sm btn-danger" href="<c:url value="/item/del/${obj.id}?mobile" />">删除</a>
			</div>
		</div>
	</div>
</div>
